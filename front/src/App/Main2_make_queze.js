...
const Main2_make_queze = () => {
    ...
    return(
        <div className="Main2_root">
            ...
            <form encType="multipart/form-data" ref={form_dom_ref} className="form_main2" method="POST" action={'http://3.34.129.99:45509/upload_img'}> {/* action="http://localhost:45509/upload_img" method="POST" action={process.env.REACR_APP_SERVER_URL+'/upload_img'} */}
