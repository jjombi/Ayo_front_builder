...
const Make_quezeshow_content_basic = ({index,file_ref,content_object,delete_,onpaste, change_text, change_title, change_img, queze_option_click,change_video_url,change_video_end_input_number,change_video_start_input_number,change_video_start,change_video_end, setMax_video_length_func}) => {
...
export default Make_quezeshow_content_basic;
