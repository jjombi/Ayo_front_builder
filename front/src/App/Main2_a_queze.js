    ...
    return(
        <div className="Main2_a_queze_root">
            ...
            <header className="Main2_a_queze_header">
                {
                    publicAccess === true ? <button title="월드컵에 세로운 선택요소를 만들 수 있습니다." className="all_btn a_queze_header_btn" onClick={()=>{ window.open(`https://ay0.netlify.app/makeaquezemodify?roomName=${roomName_ref.current}&title=${title_ref.current}`, "_blank", "noopener, noreferrer");}}>
                        월드컵 수정 하기
